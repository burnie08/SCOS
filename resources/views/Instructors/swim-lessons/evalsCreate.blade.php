    ...
    <div class="panel panel-default">
        ...
        <div class="panel-body">
            ...
            <div class="table-responsive" style="">
             ...
             {!! Form::open(['url' => '/lessons/'.$swimmer->id.'/'.$skill_card->id.'/createLesson', 'class' => 'form-horizontal', 'files' => true, 'method'=>'post']) !!}
                <input type="submit" class="btn btn-info control"  style="float:right; margin-bottom:20px;" value="Submit" >
...
<div class="widget-box">
    ...
    <div class="panel panel-default">
        ...
        <div class="panel-body">
            ...
            @php // This is how we do a php statement // lets try using it like a function. @endphp @php($cnt_skill = 1) @foreach($skills as $skill)

            <div class="col-sm-12">
                <fieldset data-role="controlgroup" data-type="horizontal">
                    <legend>{{$skill->name}}:</legend>
                    @php($cnt = 1) @foreach($levels as $level)
                    <input type="radio" name="radio-skill-{{$skill->id}}" id="radio{{$cnt_skill}}-choice-{{$cnt}}" value="{{$level->id}}" class="opt{{$cnt}} toggle" data-opt="{{$cnt}}">
            ...
            @php($cnt_skill = 1 + $cnt_skill) @endforeach
             <input type="submit" class="btn btn-info control"  style="float:right; margin-top:50px;" value="Submit" >
        </div>
